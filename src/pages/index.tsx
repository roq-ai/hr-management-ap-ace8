  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Your one-stop solution for seamless HR operations, transforming the way you manage, nurture and empower your workforce."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Your one-stop solution for seamless HR operations, transforming the way you manage, nurture and empower your workforce.`}
            </Text>
            <Box
